...
hunt = ModeKind  -- melee vs ranged with reaction fire in daylight
  ...
  , mdesc   = "Who is the hunter and who is the prey? The only criterion is remaining conscious versus becoming incapacitated when the chase ends. As far as the eye can see, the landscape is desolate."
  }
