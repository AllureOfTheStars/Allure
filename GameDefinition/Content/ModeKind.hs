...
groupNamesSingleton =
       [GAUNTLET, RAID, BRAWL, LONG, CRAWL, FOGGY, SHOOTOUT, PERILOUS, HUNT, NIGHT, FLIGHT, BURNING, ZOO, RANGED, AMBUSH, SAFARI, DIG, SEE, SHORT, FUN, CRAWL_EMPTY, CRAWL_SURVIVAL, SAFARI_SURVIVAL, BATTLE, BATTLE_DEFENSE, BATTLE_SURVIVAL, DEFENSE, DEFENSE_EMPTY]
...
crawl = ModeKind
  ...
  , mreason = "This is the main, longest and most replayable scenario of the game. The fundamental goal is the survival of your crew, including minimizing the time they are exposed to the contamination permeating the ship. Sub-goals will present themselves as you take in newly visited spaceship decks and figure out ways to reach those that are presently cut off. Gathering the saleable resources, which are gold, gems and stimpacks, is equally important as minimizing the exposure, since it's going to fund the restoration treatment at home."
...
allCaves =
  [ CAVE_GAUNTLET, CAVE_RAID, CAVE_BRAWL, CAVE_SHOOTOUT, CAVE_HUNT, CAVE_FLIGHT
