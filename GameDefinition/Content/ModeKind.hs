...
raid = ModeKind  -- mini-crawl
  ...
  , mroster = rosterRaid
  , mcaves  = cavesRaid
  , mendMsg = [ (Killed, "That was unfortunate. The bill for the rescue team and for the subsequent nano medbots treatment is beyond the pale. Perhaps more stealth was needed? Perhaps the items lying around the area could aid survival instead of ending up ignored or passively hoarded? Or perhaps a wise course of action would be to choose a Neptune Area Administration challenge with a lower difficulty this time?")
              , (Defeated, "Sadly, you got worked up in the tunnels while another team snatched the prize. Remember, you are at the Outer Frontier to gain wealth and independence through industriousness and commerce and that means clashing with competing minds, not just fighting feral nature.")
...
crawl = ModeKind
  ...
  , mroster = rosterCrawl
  , mcaves  = cavesCrawl
  , mendMsg = [ (Killed, "It was not supposed to end this way. Perhaps more stealth was in order? Perhaps the gathered items should be used for survival instead of hoarded? Or perhaps the challenge, chosen freely, but without the knowlege of the grisly difficulty, was insurmountable and lost from the very start? Nobody will know. Nobody will find out, even if somebody succeeds, another time, another way and the message gets out.")
              , (Escape, "As the shuttle doors close behind, docking clamps grind in farewell and the rotating cruiser tumbles away, you feel at once a relief and a sense of a loss. This is not finished. You are changed forever, but you know nothing. You've heard the call, but you didn't answer. You came for petty change, found a treasure beyond comprehension, then barely escaped with your life as the prize.\nAnd nobody will believe you at home. But you don't need their approval. You now have enough money to heal, regroup, track the ship down and try again. It's your personal space cruiser, after all, with a world of its own, inside.") ]
