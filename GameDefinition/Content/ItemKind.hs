...
potion16 = potionTemplate
  { ifreq    = [(CRAWL_ITEM, 100), (ANY_POTION, 50), (ANY_GLASS, 100)]
  , icount   = 1 `dL` 2
  , irarity  = [(1, 1), (10, 6)]
  , iaspects = ELabel "of melee deflection"
               : iaspects potionTemplate
  , ieffects = [ toOrganGood S_MELEE_DEFLECTING 2
               , OnSmash (Explode S_HASTE_SPRAY) ]
...
militaryKnife = knife
  ...
  , ifreq    = [ (TREASURE, 1), (WIRECUTTING_TOOL, 2), (MERCENARY_WEAPON, 70)
               , (STARTING_WEAPON, 3) ]
