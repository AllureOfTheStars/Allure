...
paralizingProj = ItemKind
  ...
  , ifeature = [toVelocity 70, Lobable, Fragile]  -- unwieldy
...
light1 = ItemKind
  ...
  , ifeature = [Lobable, Equipable]  -- not Fragile; reusable flare
...
light2 = ItemKind
  ...
  , ifeature = [Lobable, Fragile, Equipable]
...
gorget = ItemKind
  ...
  , ifeature = [Durable, Precious, Equipable]
