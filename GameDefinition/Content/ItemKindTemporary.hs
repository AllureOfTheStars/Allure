...
pattern PAINTED :: GroupName ItemKind
...
tmpPainted = tmpAspects PAINTED [ AddSkill SkArmorMelee (-50)
                                , AddSkill SkArmorRanged (-25)
                                , AddSkill SkShine 1 ]
