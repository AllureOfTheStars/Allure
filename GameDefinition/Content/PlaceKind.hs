...
maze = PlaceKind
  ...
  , pfreq    = [("rogue", 10), ("arena", 20), ("emptyExit", 25)]
  , prarity  = [(1, 12), (10, 12)]
  , pcover   = CStretch
  , pfence   = FWall
  , ptopLeft = [ "##··"
...
maze2 = maze
  { pfreq    = [("rogue", 20), ("arena", 40), ("emptyExit", 30)]
  , ptopLeft = [ "#·##·"
               , "·#··#"
               , "···#·"
               ]
...
maze3 = maze
  { pfreq    = [("rogue", 20), ("arena", 60), ("emptyExit", 40)]
  , ptopLeft = [ "##·##·"
               , "#·#··#"
               , "~·%···"
               ]
...
mazeBig = maze
  { pfreq    = [ ("rogue", 50), ("arena", 150), ("emptyExit", 50) ]
  , pfence   = FNone
  , ptopLeft = [ "X####"
               , "#·##·"
               , "##···"
...
mazeBig2 = maze
  { pfreq    = [ ("rogue", 100), ("arena", 200), ("emptyExit", 70) ]
  , pfence   = FNone
  , ptopLeft = [ "XX###~"
               , "X#···%"
               , "#·###·"
