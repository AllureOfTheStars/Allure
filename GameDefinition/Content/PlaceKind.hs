...
staircaseLift21up = staircaseLift
  { pname    = "a lift up"
  , pfreq    = [("closed lift up", 2000), ("open lift up", 2000)]
  , ptopLeft = [ "#·#··#·#"
               , "·#····#·"
               , "#··<S··#"
               , "·#····#·"
...
staircaseLift21down = staircaseLift
  { pname    = "a lift down"
  , pfreq    = [("closed lift down", 2000), ("open lift down", 2000)]
  , ptopLeft = [ "·#·##·#·"
               , "#······#"
               , "·#·S>·#·"
               , "#······#"
...
cells6 = cells
  ...
  , pfreq    = [("laboratory", 5), ("empty", 5), ("noise", 3), ("zoo", 30)]
  , ptopLeft = [ "··#"
               , "##'"
               ]
  }
cells7 = cells
  ...
  , pfreq    = [ ("rogue", 3), (" laboratory", 5), ("empty", 5)
               , ("noise", 3) ]
  , pfence   = FFloor
  , ptopLeft = [ "#·#"
               , "·%·"
