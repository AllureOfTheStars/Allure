...
pillar = PlaceKind
  { psymbol  = 'p'
  , pname    = "a market"
  , pfreq    = [("rogue", 600), ("arena", 2000), ("empty", 70)]
  , prarity  = [(1, 5), (10, 5)]
  , pcover   = CStretch
  , pfence   = FWall
...
pillar2 = pillar
  { pname    = "a plaza"
  , pfreq    = [("rogue", 600), ("arena", 5000), ("empty", 200)]
  , prarity  = [(1, 15), (10, 15)]
  , ptopLeft = [ "O····"
               , "·····"
               , "·····"
...
pillar6 = pillar
  ...
  , pfreq    = [ ("rogue", 400), ("arena", 2000), ("empty", 150) ]
  , prarity  = [(1, 3), (10, 3)]
  , ptopLeft = [ "Of··"
               , "ff%·"
               , "·%&·"
...
ovalFloor = oval
  { pfreq    = [ ("rogue", 4000), ("arena", 6000), ("laboratory", 4000)
...
maze = PlaceKind
  ...
  , pfreq    = [("rogue", 40), ("arena", 1), ("emptyExit", 100)]
  , prarity  = [(1, 3), (10, 3)]
  , pcover   = CStretch
  , pfence   = FWall
  , ptopLeft = [ "##··"
...
maze3 = maze
  { pfreq    = [("rogue", 80), ("arena", 3), ("emptyExit", 160)]
  , ptopLeft = [ "##·##·"
               , "#·#··#"
               , "~·%···"
               ]
