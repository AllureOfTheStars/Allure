...
groupNamesSingleton =
    ...
    ++ [S_BUSH_DARK, S_SHALLOW_WATER_DARK]
...
pattern S_BUSH_DARK, S_SHALLOW_WATER_DARK :: GroupName TileKind
...
groupNames =
    ...
    ++ [TREE_SHADE_WALKABLE_LIT, TREE_SHADE_WALKABLE_DARK, SMOKE_CLUMP_LIT, SMOKE_CLUMP_DARK, ASHES_SMOKE_LIT, ASHES_SMOKE_DARK, BUSH_CLUMP_LIT, BUSH_CLUMP_DARK, BUSH_GROVE_LIT, BUSH_GROVE_DARK, UNDERBRUSH_CLUMP_LIT, UNDERBRUSH_CLUMP_DARK, FOG_CLUMP_LIT, FOG_CLUMP_DARK, STAIR_TERMINAL_LIT, STAIR_TERMINAL_DARK, SIGNBOARD, STAIRCASE_UP, ORDINARY_STAIRCASE_UP, STAIRCASE_OUTDOOR_UP, GATED_STAIRCASE_UP, STAIRCASE_DOWN, ORDINARY_STAIRCASE_DOWN, STAIRCASE_OUTDOOR_DOWN, GATED_STAIRCASE_DOWN, ESCAPE_UP, ESCAPE_DOWN, ESCAPE_OUTDOOR_DOWN]
    ...
    ++ [BRAWL_SET_DARK, NOISE_SET_DARK, SHOOTOUT_SET_DARK, EXIT_SET_DARK, HUNT_SET_DARK, FLOOR_ACTOR_ITEM_DARK]
...
-- ** Allure-specific
pattern RECT_WINDOWS, DOORLESS_MACHINERY, PUMPS_LIT, PUMPS_DARK, DOORLESS_WALL, OIL_RESIDUE_LIT, OIL_RESIDUE_DARK, LIFT_TERMINAL_LIT, LIFT_TERMINAL_DARK, STAIRCASE_LIFT_UP, STAIRCASE_LIFT_DOWN, GATED_LIFT_UP, GATED_LIFT_DOWN, DECONTAMINATING_STAIRCASE_UP, DECONTAMINATING_STAIRCASE_DOWN, DECONTAMINATING_LIFT_UP, DECONTAMINATING_LIFT_DOWN, WELDED_STAIRCASE_UP, WELDED_LIFT_UP, ESCAPE_SPACESHIP_DOWN, ORDINARY_LIFT_UP, ORDINARY_LIFT_DOWN, RUBBLE_OR_WASTE_LIT, RUBBLE_OR_WASTE_DARK, CACHE_DEPOSIT, CACHE_JEWELRY, CACHE_MAZE, CACHE_SHUTTLE, TRAPPED_DOOR, FLOOR_ACTOR_ITEM, FLOOR_ACTOR_ITEM_LIT, STUCK_DOOR, BARREL :: GroupName TileKind
...
pattern BRAWL_SET_DARK, NOISE_SET_DARK, SHOOTOUT_SET_DARK, EXIT_SET_DARK, HUNT_SET_DARK, FLOOR_ACTOR_ITEM_DARK :: GroupName TileKind
...
bush = TileKind
  ...
  , tfreq    = [ (S_BUSH_LIT, 1), (EMPTY_SET_LIT, 2), (ARENA_SET_LIT, 10)
               ...
               , (BUSH_CLUMP_LIT, 1), (BUSH_GROVE_LIT, 5), (PUMPS_LIT, 60)
               , (LIFT_TERMINAL_LIT, 4) ]
  , tcolor   = BrGreen
  , tcolor2  = Green
  , talter   = 4
...
floorDirtSpice = floorDirt
  { tfreq    = [ (TREE_SHADE_WALKABLE_LIT, 1), (BUSH_CLUMP_LIT, 1)
               , (BUSH_GROVE_LIT, 3), (UNDERBRUSH_CLUMP_LIT, 1)
               , (PUMPS_LIT, 200) ]
...
rubbleBurning = TileKind  -- present in EMPTY_SET_LIT as early light/fire source
  ...
  , tfeature = [ OpenWith True [(3, WATER_SOURCE)] S_SMOKE_LIT
               , OpenWith True [(1, BLAST_SOURCE)] ASHES_SMOKE_LIT
...
barrel = TileKind
  ...
  , tfeature = [ Embed BARREL_CONTENTS
               , OpenWith True [] ASHES_SMOKE_LIT ]  -- no pathfinding through
  }
barrelSpice = barrel
  { tfreq    = [ (SMOKE_CLUMP_LIT, 1), (SMOKE_CLUMP_DARK, 1)
...
bushEdible = TileKind
  ...
  , tfreq    = [ (EMPTY_SET_LIT, 4), (ARENA_SET_LIT, 1), (ARENA_SET_DARK, 1)
               ...
               , (BUSH_GROVE_LIT, 1), (BUSH_GROVE_DARK, 1)
