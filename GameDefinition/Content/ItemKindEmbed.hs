...
module Content.ItemKindEmbed
  ...
  , pattern BONDING_TOOL, pattern SHARPENING_TOOL, pattern WIRECUTTING_TOOL, pattern EDIBLE_PLANT, pattern FIRE_FIGHTING_ITEM, pattern REFRIGERATION_COIL, pattern PERFUME_POTION, pattern ROSE_WATER_FLASK, pattern STEEL_SCRAP, pattern HANDLE, pattern POLE, pattern HANDLE_AND_STEEL, pattern POLE_AND_STEEL
...
embedsGN =
    ...
    ++ [BONDING_TOOL, SHARPENING_TOOL, WIRECUTTING_TOOL, EDIBLE_PLANT, FIRE_FIGHTING_ITEM, REFRIGERATION_COIL, PERFUME_POTION, ROSE_WATER_FLASK, STEEL_SCRAP, HANDLE, POLE, HANDLE_AND_STEEL, POLE_AND_STEEL]
...
pattern SANDSTONE_ROCK :: GroupName ItemKind
...
pattern BONDING_TOOL, SHARPENING_TOOL, WIRECUTTING_TOOL, EDIBLE_PLANT, FIRE_FIGHTING_ITEM, REFRIGERATION_COIL, PERFUME_POTION, ROSE_WATER_FLASK, STEEL_SCRAP, HANDLE, POLE, HANDLE_AND_STEEL, POLE_AND_STEEL :: GroupName ItemKind
...
workshopAssocs =
  ...
  , ([(1, WATER_SOURCE), (1, PERFUME_POTION)], [(5, ROSE_WATER_FLASK)])
  ]
