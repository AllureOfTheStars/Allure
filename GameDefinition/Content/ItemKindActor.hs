...
module Content.ItemKindActor
  ...
  , pattern COOKED_FOOD, pattern MERCENARY_WEAPON, pattern S_BULLTEPROOF_VEST, pattern MERCENARY_AMMO, pattern RAW_MEAT_CHUNK, pattern ROASTED_MEAT_CHUNK, pattern NEEDLE, pattern CAN_OF_STICKY_FOAM, pattern TRANQUILIZER_DART, pattern WASTE_CONTAINER, pattern CONSTRUCTION_HOOTER, pattern SPOTLIGHT, pattern BLOWTORCH
  , actorsGN
  , -- * Content
    actors
  ) where
...
actorsGN =
    ...
    ++ [COOKED_FOOD, MERCENARY_WEAPON, S_BULLTEPROOF_VEST, MERCENARY_AMMO, RAW_MEAT_CHUNK, ROASTED_MEAT_CHUNK, NEEDLE, CAN_OF_STICKY_FOAM, TRANQUILIZER_DART, WASTE_CONTAINER, CONSTRUCTION_HOOTER, SPOTLIGHT, BLOWTORCH]
...
pattern COOKED_FOOD, MERCENARY_WEAPON, S_BULLTEPROOF_VEST, MERCENARY_AMMO, RAW_MEAT_CHUNK, ROASTED_MEAT_CHUNK, NEEDLE, CAN_OF_STICKY_FOAM, TRANQUILIZER_DART, WASTE_CONTAINER, CONSTRUCTION_HOOTER, SPOTLIGHT, BLOWTORCH :: GroupName ItemKind
