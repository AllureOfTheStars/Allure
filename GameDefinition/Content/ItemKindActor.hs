...
razorwireFence = ItemKind
  ...
  , icount   = 1
  , irarity  = [(3 * 10/15, 0), (4 * 10/15, 15)]  -- quickly vanishes at depth
  , iverbHit = "scrape"
  , iweight  = 80000
  , idamage  = 0
...
shepherdDrone = ItemKind
  ...
  , ikit     = [ ("live wire", COrgan), ("eye 6", COrgan), ("ear 6", COrgan)
               , ("robot brain", COrgan) ]
  }
