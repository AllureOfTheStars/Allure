...
actorsGN =
    ...
    ++ [COOKED_FOOD, MERCENARY_WEAPON, S_BULLTEPROOF_VEST, MERCENARY_AMMO, RAW_MEAT_CHUNK, ROASTED_MEAT_CHUNK, NEEDLE, CAN_OF_STICKY_FOAM, TRANQUILIZER_DART, WASTE_CONTAINER, CONSTRUCTION_HOOTER, SPOTLIGHT, BLOWTORCH, POLE]
...
pattern COOKED_FOOD, MERCENARY_WEAPON, S_BULLTEPROOF_VEST, MERCENARY_AMMO, RAW_MEAT_CHUNK, ROASTED_MEAT_CHUNK, NEEDLE, CAN_OF_STICKY_FOAM, TRANQUILIZER_DART, WASTE_CONTAINER, CONSTRUCTION_HOOTER, SPOTLIGHT, BLOWTORCH, POLE :: GroupName ItemKind
...
electricFence = ItemKind
  ...
  , iaspects = [ AddSkill SkArmorMelee 30, AddSkill SkArmorRanged 15
               ...
               , SetFlag Durable ]
  , ieffects = []
  , idesc    = "Marginally intelligent electric shepherd. Originally used in orbital dairy farms and planetary zoos. The tall pole on which proximity sensors, actuators and wires are socketed, ensures animals can't jump above the fence, even in reduced gravity."
