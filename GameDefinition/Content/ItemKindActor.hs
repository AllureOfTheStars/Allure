...
hornetSwarm = ItemKind
  ...
  , iflavour = zipPlain [Magenta]
  , icount   = 1
  , irarity  = [(5, 1), (10, 5)]  -- should be many, because die after a time
  , iverbHit = "buzz"
  , iweight  = 1000
  , idamage  = 0
...
razorwireFence = ItemKind
  ...
  , icount   = 1
  , irarity  = [(3 * 10/12, 0), (4 * 10/12, 12)]  -- quickly vanishes at depth
  , iverbHit = "scrape"
  , iweight  = 80000
  , idamage  = 0
...
steamFaucet = ItemKind
  { isymbol  = 'f'
  , iname    = "steam faucet"
  , ifreq    = [("robot", 10), ("immobile robot", 15)]
