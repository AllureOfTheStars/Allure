...
test-medium: testExploration-medium testRaid-medium testBrawl-medium testAmbush-medium testBattle-medium testBattleSurvival-medium testSafari-medium testSafariSurvival-medium testCoop-medium testDefense-medium

test-medium-no-safari: testExploration-medium testRaid-medium testBrawl-medium testAmbush-medium testBattle-medium testBattleSurvival-medium testCoop-medium testDefense-medium
...
testPvP-long:
	dist/build/Allure/Allure --dbgMsgSer --newGame 5 --noAnim --maxFps 100000 --frontendStd --benchmark --stopAfterSeconds 60 --dumpInitRngs --automateAll --keepAutomated --gameMode PvP 2> /tmp/stdtest.log

testPvP-medium:
	dist/build/Allure/Allure --dbgMsgSer --newGame 5 --noAnim --maxFps 100000 --frontendStd --benchmark --stopAfterSeconds 30 --dumpInitRngs --automateAll --keepAutomated --gameMode PvP 2> /tmp/stdtest.log

testCoop-long:
	dist/build/Allure/Allure --dbgMsgSer --newGame 2 --noAnim --maxFps 100000 --frontendStd --benchmark --stopAfterSeconds 500 --dumpInitRngs --automateAll --keepAutomated --gameMode Coop 2> /tmp/stdtest.log

testCoop-medium:
	dist/build/Allure/Allure --dbgMsgSer --newGame 2 --noAnim --maxFps 100000 --frontendStd --benchmark --stopAfterSeconds 300 --dumpInitRngs --automateAll --keepAutomated --gameMode Coop 2> /tmp/stdtest.log
...
test-short-new:
	...
	dist/build/Allure/Allure --dbgMsgSer --newGame 5 --savePrefix PvP --dumpInitRngs --automateAll --keepAutomated --gameMode PvP --frontendStd --stopAfterSeconds 2 2> /tmp/stdtest.log
	dist/build/Allure/Allure --dbgMsgSer --newGame 5 --savePrefix Coop --dumpInitRngs --automateAll --keepAutomated --gameMode Coop --frontendStd --stopAfterSeconds 2 2> /tmp/stdtest.log
...
test-short-load:
	...
	dist/build/Allure/Allure --dbgMsgSer --savePrefix PvP --dumpInitRngs --automateAll --keepAutomated --gameMode PvP --frontendStd --stopAfterSeconds 2 2> /tmp/stdtest.log
	dist/build/Allure/Allure --dbgMsgSer --savePrefix Coop --dumpInitRngs --automateAll --keepAutomated --gameMode Coop --frontendStd --stopAfterSeconds 2 2> /tmp/stdtest.log
