...
expose-lore:
	dist/build/Allure/Allure --dbgMsgSer --logPriority 4 --savePrefix know --newGame 5 --dumpInitRngs --gameMode crawl --knowItems --recallPlaces --benchmark --noAnim --maxFps 1000

dig-crawl:
	dist/build/Allure/Allure --dbgMsgSer --logPriority 4 --savePrefix know --newGame 5 --dumpInitRngs --gameMode dig --knowItems --recallPlaces --benchmark --noAnim --maxFps 1000

see-caves:
	dist/build/Allure/Allure --dbgMsgSer --logPriority 4 --savePrefix know --newGame 5 --dumpInitRngs --gameMode see --knowItems --recallPlaces --benchmark --noAnim --maxFps 1000
